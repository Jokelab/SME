...
{
    public class PhpTokenComposer : ITokenComposer
    {
        ...
        ISourceTokenProvider _sourceTokenProvider;
        ...
        public void ConsumeToken(Tokens token, string text, Span position)
        {
            ...
            ProcessToken(token, _sourceTokenProvider.GetTokenText(new SourceToken(token, position), text), position);
